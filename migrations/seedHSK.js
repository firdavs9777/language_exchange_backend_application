/**
 * Migration: seed HSK (Hanyu Shuiping Kaoshi) exam content
 * with 1–6 proficiency levels, full section coverage, and ~3,420 questions.
 *
 * Seeds:
 *   1 language  (Chinese)
 *   6 exams     (HSK/1, HSK/2, HSK/3, HSK/4, HSK/5, HSK/6)
