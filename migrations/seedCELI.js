/**
 * Migration: seed CELI (Certificato di Conoscenza della Lingua Italiana) exam content
 * with A1–C2 proficiency levels, full section coverage, and ~3,420 questions.
 *
 * Seeds:
 *   1 language  (Italian)
 *   6 exams     (CELI/A1, CELI/A2, CELI/B1, CELI/B2, CELI/C1, CELI/C2)
 *   36 sections (6 sections × 6 levels)
 *   ~3,420 questions (~570 questions per level, ~95 questions per section × 6 sections × 6 levels)
 *
