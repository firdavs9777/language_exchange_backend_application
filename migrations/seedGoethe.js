/**
 * Migration: seed Goethe (Goethe-Institut) exam content
 * with A1–C2 proficiency levels, full section coverage, and ~3,420 questions.
 *
 * Seeds:
 *   1 language  (German)
 *   6 exams     (Goethe/A1, Goethe/A2, Goethe/B1, Goethe/B2, Goethe/C1, Goethe/C2)
 *   36 sections (6 sections × 6 levels)
 *   ~3,420 questions (~570 questions per level × 6 levels)
 *
