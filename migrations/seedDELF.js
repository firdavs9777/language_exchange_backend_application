/**
 * Migration: seed DELF (Diplôme d'Études en Langue Française) exam content
 * with A1–B2 proficiency levels, full section coverage, and ~2,280 questions.
 *
 * Seeds:
 *   1 language  (French)
 *   4 exams     (DELF/A1, DELF/A2, DELF/B1, DELF/B2)
 *   24 sections (6 sections × 4 levels)
 *   ~2,280 questions (~150 questions per section × 6 sections × 4 levels)
 *
