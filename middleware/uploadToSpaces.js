...
// Use Cloudflare CDN URL for faster global delivery (fallback to DO CDN)
const BUCKET_URL = process.env.SPACES_CDN_URL || `https://${BUCKET_NAME}.${BUCKET_REGION}.cdn.digitaloceanspaces.com`;
